    ...
    var KTTablesWidget4 = (function () {
            ...
            e.forEach((e, t) => {
                e.addEventListener("click", (l) => {
                    ...
                    if (r.classList.contains("isOpen")) {
                        while (
                            r.nextSibling &&
                            "subtable_template" === r.nextSibling.getAttribute("data-kt-table-widget-4")
                        ) {
        ...
        const i = (a, l) => {
            a.forEach((o, r) => {
                ...
                const m = i.querySelector('[data-kt-table-widget-4="template_description"]');
                const d = i.querySelector('[data-kt-table-widget-4="template_cost"]');
                const g = i.querySelector('[data-kt-table-widget-4="template_qty"]');
                const c = i.querySelector('[data-kt-table-widget-4="template_total"]');
                const f = i.querySelector('[data-kt-table-widget-4="template_stock"]');
                const newColumn1 = i.querySelector('[data-kt-table-widget-4="template_new_column1"]');
                const newColumn2 = i.querySelector('[data-kt-table-widget-4="template_new_column2"]');
                ...
                newColumn1.innerText = o.newColumn1;
                newColumn2.innerText = o.newColumn2;
        ...
        const s = () => {
            ...
            e.querySelectorAll("tbody tr").forEach((e) => {
                ...
                if (e.querySelector('[data-kt-table-widget-4="expand_row"]')) {
