        ...
        init: function () {
            (() => {
                var o = FormValidation.formValidation(e, {
                    fields: {
                        application_model: {validators: {notEmpty: {message: "Application model is required"}}},
                        permission_name: {validators: {notEmpty: {message: "Permission name is required"}}},
                        permission_codename: {validators: {notEmpty: {message: "Permission codename is required"}}},
                ...
                i.addEventListener("click", (function (t) {
                    t.preventDefault(), o && o.validate().then((function (t) {
                        console.log("validated!"), "Valid" == t ? (i.setAttribute("data-kt-indicator", "on"), i.disabled = !0, setTimeout((function () {
                            i.removeAttribute("data-kt-indicator"), i.disabled = !1, $("#kt_modal_update_permission_form").submit();
                        }), 2e3)) : Swal.fire({
